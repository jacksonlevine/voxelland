...
impl DoorInfo {
    ...
    pub fn base_door_model() -> &'static [f32] {
        static player_is_minus_z: [f32; 150] = [
            -0.5, -0.5, -0.5,0.0, 16.0,//ront
            0.5, -0.5, -0.5,0.0, 16.0,
            0.5, 0.5, -0.5,0.0, 16.0,
            ...
            -0.5, -0.5, -0.5,0.0, 16.0,
            -0.5, 0.5, -0.5,0.0, 16.0,
            -0.5, 0.5, -0.25,0.0, 16.0,

            -0.5, 0.5, -0.25,0.0, 16.0,
            -0.5, -0.5, -0.25,0.0, 16.0,
            -0.5, -0.5, -0.5,0.0, 16.0,//let
